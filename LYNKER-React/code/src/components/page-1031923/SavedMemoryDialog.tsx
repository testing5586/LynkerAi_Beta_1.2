...
export default function SavedMemoryDialog() {
...
// Get all unique tags
  ...
  return (
    <Dialog open={isOpen && isClient} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0 gap-0">
        {/* Header */}
        <DialogHeader className="border-b px-6 py-4 flex-shrink-0">
          <div className="flex items-center justify-between">
            <div>
              <DialogTitle className="text-2xl font-bold text-gradient-mystical flex items-center gap-2">
